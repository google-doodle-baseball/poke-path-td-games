...
const CREDITS = {
	...
	mapArtist: {
		label: ['Map Artist', 'Artista de mapas', 'Artiste des cartes', 'Artista de mapas', 'Artista di mappe', 'Kartenkünstler', 'マップアーティスト', '지도 아티스트', '地图绘师'],
		content: 'NOELLE'
	},
	testers: {
		label: ['Testers', 'Testers', 'Testeurs', 'Testadores', 'Tester', 'Tester', 'テスター', '테스터', '测试员'],
		content: '<a href="https://www.youtube.com/@KhytrayerDofus/videos" target="_blank" class="link-red">KHYTRAYER</a> & SINGA'
	},
	traductions: {
		...
		label: {
			...
			1: ["Korean", "Coreano", "Coréen", "Coreano", "Coreano", "Koreanisch", "韓国語", "한국어", '韩语'],
			2: ["French", "Francés", "Français", "Francês", "Francese", "Französisch", "フランス語", "프랑스어", '法语'],
		},
		content: {
...
const SHORTCUTS = {
	...
	do: {
		...
		9: ["Toggle Speed", "Cambiar Velocidad", "Modifier Vitesse", "Alternar Velocidade", "Cambia Velocità", "Geschw. wechseln",  "速度切替", "속도 전환", "切換速度"],
...
export class MenuScene extends GameScene {
	...
	render() {
		...
		this.version = new Element(this.contentData, { className: 'menu-scene-version', text: `v 1.3.6` }).element;
