...
export class ProfileScene extends GameScene {
	...
	update() {
		...
		this.stats[4].value.innerText = `${this.main.utility.numberDot(this.main.player.stats.totalPokemonLevel, this.main.lang)}/${this.main.utility.numberDot(9000, this.main.lang)}`;
