...
export const pokemonData = {
	...
	fuecoco: {
		id: 73,
		key: 'fuecoco',
		name: ["Fuecoco","Fuecoco","Chochodile","Fuecoco","Fuecoco","Fuecoco","フエココ","후에코코", '呆火鳄'],
		color: '#b81000',
	...
	crocalor: {
		id: 73,
		key: 'crocalor',
		name: ["Crocalor","Crocalor","Crocogril","Crocalor","Crocalor","Crocalor","クロカロール","크로카롤", '炙烫鳄'],
		color: '#de3b2e',
		ability: abilityData['willOWisp'],
		projectileSound: 'projectile1',
		projectileSpeed: 7,
	...
	skeledirge: {
		id: 73,
		key: 'skeledirge',
		name: ["Skeledirge","Skeledirge","Flâmigator","Skeledirge","Skeledirge","Skeledirge","スケルディルガ","스켈디르가", '骨纹巨声鳄'],
		color: '#d74e40',
		ability: abilityData['willOWisp'],
		projectileSound: 'projectile1',
		projectileSpeed: 7,
	...
	cherrim: {
		id: 75,
		key: 'cherrim',
		name: ["Cherrim", "Cherrim", "Ceriflor", "Cherrim", "Cherrim", "Cherrim", "チェリム", "체리림", '樱花儿'],
		color: '#9e5fc6',
		ability: abilityData['doubleShot'],
		projectileSound: 'projectile5',
		projectileSpeed: 7,
	...
	rockruff: {
		id: 76,
		key: 'rockruff',
		name: ["Rockruff", "Rockruff", "Rocabot", "Rockruff", "Rockruff", "Rockruff", "イワンコ", "바우드", '岩狗狗'],
		color: '#ab6a5a',
	...
	lycanrocDay: {
		id: 76,
		key: 'lycanrocDay',
		name: ["Lycanroc", "Lycanroc", "Lougaroc", "Lycanroc", "Lycanroc", "Wolwerock", "ルガルガン", "라이칸록", '鬃岩狼人'],
		color: '#a17e6f',
	...
	cacturne: {
		id: 85,
		key: 'cacturne',
		name: ["Cacturne","Cacturne","Cacturne","Cacturne","Cacturne","Tengulist","ノクタス","다탱구", '梦歌仙人掌'],
		color: '#4ea51c',
	...
	sharpedo: {
		id: 90,
		key: 'sharpedo',
		name: ["Sharpedo", "Sharpedo", "Sharpedo", "Sharpedo", "Sharpedo", "Tohaido", "サメハダー", "샤크니아드", '巨牙鲨'],
		color: '#6687ae',
		ability: abilityData['speedBoost'],
		projectileSound: 'projectile3',
		projectileSpeed: 7,
