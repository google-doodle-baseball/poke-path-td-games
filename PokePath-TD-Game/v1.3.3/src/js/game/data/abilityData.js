export const abilityData = {
	...
	swimmer: {
		...
		description: [
		    ...
		    "Réduit de moitié le temps de recharge lorsqu'il est dans l'eau.",
	...
	burn: {
		id: 'burn',
		name: ['Burn', 'Quemadura', 'Brûlure', 'Queimadura', 'Bruciatura', 'Verbrennung', 'やけど', '화상', '灼伤'],
		description: [
	...
	slow: {
		id: 'slow',
		name: ['Slow', 'Ralentizar', 'Ralentir', 'Retardar', 'Rallentare', 'Verlangsamen', 'スロウ', '느리게 하기', '减速'],
		description: [
	...
	stunMono: {
		id: 'stunMono',
		name: ['Stun', 'Aturdir', 'Étourdir', 'Atordoar', 'Stordire', 'Betäuben', 'スタン', '기절', '眩暈'],
		description: [
	...
	synchronySplash: {
		id: 'synchronySplash',
		name: ['Synchrony', 'Sincronía', 'Synchronisation', 'Sincronia', 'Sincronia', 'Synchronisation', 'シンクロ', '싱크로', '同步'] ,
		description: [
		    ...
		    "Les projectiles explosent en zone, infligeant la moitié des dégâts aux ennemis proches et propageant les états de la cible principale (brûlure, poison, étourdissement, ralentissement).",
	...
	fieryDance: {
		...
		description: [
			...
			'Double les dégâts infligés aux ennemis brûlés.', 
	...
	willOWisp: {
		...
		description: [
			...
			"Si la cible est maudite, inflige des dégâts à tous les ennemis maudits et les brûle.",
	...
	sniper: {
		id: 'sniper',
		name: ["Sniper", "Francotirador", "Tireur d'élite", "Atirador de Elite", "Cecchino", "Scharfschütze", "スナイパー", "저격수", "狙击手"],
		description: [
	...
	toughClaws: {
		...
		description: [
			...
			"Augmente sa puissance de 50 % lorsqu'il se trouve sur une montagne. Son taux de critique passe à 100 % lorsqu'il est dans les hautes herbes.",
	...
	triage: {
		...
		description: [
			...
			"Réduit le temps de recharge des Pokémon à portée de 25 %. À la fin de la vague, a 5 % de chance de récupérer 1 cœur.",
	...
	doubleShotSand: {
		...
		description: [
			...
			`Tire des projectiles sur jusqu’à 2 ennemis à la fois. Double sa portée sur la Route 2.`,
	...
	quadraShotSand: {
		...
		description: [
			...
			'Tire des projectiles sur jusqu’à 4 ennemis à la fois. Double sa portée sur la Route 2.',
