export const itemData = {
	...
	carbos: { 
		...
		description: [
			...
			"Réduit la vitesse de recharge de 15 %.",
	...
	lifeOrb: {
		...
		description: [
			...
			"Les attaques ne restaurent plus les cœurs. Le porteur gagne +50 % de dégâts et -50 % de temps de recharge. Seuls les Pokémon qui restaurent des cœurs peuvent le tenir.",
	...
	twistedSpoon: {
		...
		description: [
			...
			"Le Pokémon se concentre sur la téléportation sur place, au prix d'une réduction de 75 % des dégâts par accumulation. Ne peut être tenu que par Abra, Kadabra ou Alakazam.",
			...
			"Das Pokémon konzentriert sich darauf, sich an Ort und Stelle zu teleportieren, auf Kosten einer 75%igen Reduzierung des Schadens pro Stapel. Kann nur von Abra, Kadabra oder Alakazam getragen werden.",
	...
	clefairyDoll: { 
		...
		description: [
			...
			"Restaure 1 cœur après avoir infligé 25 000 dégâts, ne peut être tenu que par Mélofée ou Mélodelfe.",
	...
	amuletCoin: {
		...
		description: [
			...
			"Les attaques accordent $ équivalent à 3 % des dégâts infligés en or.",
	...
	fertiliser: { 
		...
		description: [
			...
			"Le terrain de type champ se comporte plutôt comme de l'herbe pour le porteur.",
	...
	heartScale: {
		...
		description: [
			...
			"Après avoir récupéré un cœur, le Pokémon qui tient cet objet verra sa vitesse de recharge réduite de 50 % pour le reste de la vague.",
	...
	squirtBottle: { 
		...
		description: [
			...
			"Le terrain de type champ se comporte plutôt comme de l'eau pour le porteur.",
	...
	choiceScarf: { 
		id: 'choiceScarf',
		name: ['Choice Scarf', 'Pañuelo Elegido', 'Écharpe Choix', 'Lenço Escolha', 'Sciarpa Scelta', 'Wahlschal', 'こだわりスカーフ', '구애스카프', '拘束圍巾'],
		...
		description: [
			...
			"Réduit le nombre de projectiles à un, mais diminue le temps de recharge de 20 % pour chaque projectile perdu. Lileep et Cradily ne peuvent pas tenir cet objet.",
			...
			"Reduziert die Anzahl der Projektile auf eins, verringert jedoch die Wiederaufladezeit um 20 % für jedes verlorene Projektil. Lileep und Cradily können diesen Gegenstand nicht halten.",
			"弾の数を1に減らすが、失った弾ごとに再装填時間が20%短くなる。リリーラとラクライはこのアイテムを持てない。",
			"투사체 수를 1로 줄이지만, 잃은 투사체마다 재장전 시간이 20% 감소합니다. 라일리프와 크래드릴리는 이 아이템을 들 수 없습니다.",
	...
	airBalloon: {
		...
		description: [
			...
			'Dieses Item ermöglicht es, Feld-/Grasgebiet-Pokémon in Berg-Gelände zu platzieren.', 
	...
	oldRod: { 
		...
		description: [
			...
			"Augmente la portée de 60. Ne peut être tenu que par Magicarpe ou Léviator.",
			...
			"Reichweite wird um 60 erhöht. Kann nur von Karpador oder Garados getragen werden.",
	...
	heatRock: {
		...
		description: [
			...
			"Augmente la durée de brûlure à 20 secondes. Ne peut être tenu que par Charmina.",
			...
			"Erhöht die Dauer des Brandes auf 20 Sekunden. Kann nur von Torkoal getragen werden.",
			"やけどの持続時間が20秒になる。コータスのみが持てる。",
			"화상 지속 시간이 20초로 증가합니다. 토르코알만 이 아이템을 들 수 있습니다.",
	...
	dampMulch: { 
		...
		description: [
			...
			"Cet objet permet de placer uniquement les Pokémon de type Eau sur le terrain.",
			...
			"Dieses Item erlaubt es ausschließlich Wasser-Pokémon, auf das Spielfeld gesetzt zu werden.",
	...
	heavyDutyBoots: {
		...
		description: [
			...
			'Dieses Item erlaubt ausschließlich Feld-Pokémon, auf Gras platziert zu werden.',
			'このアイテムを持つと、フィールド専用のポケモンを草むらに配置できる。',
			'이 아이템을 사용하면 필드 전용 포켓몬만 풀 지역에 배치할 수 있다.',
			'此道具僅允許場地型寶可夢被放置於草地。'
		],
		restriction: {
			tileForbidden: [2, 3, 4]
	...
	shieldBreakerBullet: { 
		...
		name: ['Shield Breaker Bullet', 'Bala Rompeescudos', 'Balle Brise-Bouclier', 'Projétil Quebrador de Escudo', 'Proiettile Spaccascudo', 'Schildbrecher-Kugel', 'シールドブレイカーバレット', '실드 브레이커 탄환', '破盾子彈'],
		...
		description: [
			...
			"Inflige le double de dégâts à l'armure, ne peut être tenu que par Flingouste ou Gamblast. Augmente le temps de recharge de 2 secondes.",
			...
			"Verursacht doppelten Schaden an der Rüstung, kann nur von Scampisto oder Wummer gehalten werden. Erhöht die Wiederaufladezeit um 2 Sekunden.",
	...
	shellBell: { 
		...
		description: [
			...
			"Une fois par round, restaure 1 cœur après avoir infligé 50 000 dégâts.",
	...
	stickyBarb: { 
		...
		description: [
			...
			"Augmente les dégâts de 15 % aux ennemis ralentis ou étourdis. Seulement pour les Pokémon pouvant être déployés dans l'eau.",
	...
	starCandy: { 
		id: 'starCandy',
		name: ["Star Candy", "Caramelo Estrella", "Bonbon Étoile", "Doce Estrela", "Caramella Stella", "Sternbonbon", "スターキャンディ", "스타 캔디", "星星糖果"],
		...
		description: [
			...
			"Gagnez 0,1 de portée supplémentaire par étoile, ne peut être tenu que par Mélofée ou Mélodelfe.",
			...
			"Erhält 0,1 zusätzliche Reichweite pro Stern, kann nur von Pummeluff oder Knuddeluff gehalten werden.",
	...
	electirizer: { 
		...
		description: [
			...
			"Inflige 30 % de dégâts supplémentaires aux ennemis étourdis. Seuls les Pokémon capables d'infliger l'étourdissement peuvent l'équiper.",
	...
	cellBattery: { 
		...
		description: [
		  	...
		  	"Toutes les attaques provoquent l'étourdissement, mais la durée de l'étourdissement est réduite de 95 %. Ne peut être tenu que par Voltorbe ou Électrode.",
	...
	leek: {
		id: 'leek',
		name: ['Leek', 'Puerro', 'Poireau', 'Alho-poró', 'Porro', 'Lauch', 'ネギ', '파', '大蔥'],
		...
		description: [
			...
			"Verdoppelt die Chance auf einen kritischen Treffer und den kritischen Schaden, kann nur von Farfetch'd gehalten werden.",
			"急所に当たる確率と急所ダメージが2倍になり、カモネギのみが装備可能です。",
			"치명타 확률과 치명타 피해가 2배가 되며, 파르셀만 장착할 수 있습니다.",
			"暴擊率與暴擊傷害加倍，僅限大蔥鴨攜帶。"
		],
		restriction: { 
			id: [57]
	...
	thickClub: {
		...
		price: 75000,
		description: [
			'Increases damage dealt by 50%, can only be held by Cubone or Marowak.',
			'Aumenta el daño causado un 50%, solo puede llevarlo Cubone o Marowak.',
			'Augmente les dégâts infligés de 50 % , ne peut être porté que par Osselait ou Ossatueur.',
			'Aumenta o dano causado em 50%, só pode ser equipado por Cubone ou Marowak.',
			'Aumenta i danni inflitti del 50%, può essere indossato solo da Cubone o Marowak.',
			'Erhöht den verursachten Schaden um 50 %, kann nur von Tragosso oder Knogga getragen werden.',
			'与えるダメージが50%上がる。カラカラかガラガラのみが持てる。',
			'입히는 데미지가 50% 증가한다. 단, 탕구리 또는 텅구리만 착용 가능.',
			'造成的傷害提高 50%，僅限卡拉卡拉或嘎啦嘎啦攜帶。'
		],
		restriction: {
			id: [45]
		}
	...
	lightBall: {
		id: 'lightBall',
		name: ["Light Ball","Bola luminosa","Boule lumineuse","Bola luminosa","Palla luminosa","Lichtball","ライトボール","라이트볼","電氣球"],
		...
		description: [
			...
			"Augmente les dégâts infligés de 50 %, ne peut être tenu que par Pikachu ou Raichu.",
			...
			"Erhöht den verursachten Schaden um 50%, kann nur von Pikachu oder Raichu gehalten werden.",
	...
	nanabBerry: { 
		...
		description: [
			...
			"Inflige 50 % de dégâts supplémentaires aux ennemis avec armure. Ne peut être tenu que par Mankey ou Primeape.",
			...
			"Fügt gepanzerten Gegnern 50 % zusätzlichen Schaden zu. Kann nur von Mankey oder Primeape gehalten werden.",
			"アーマーを持つ敵に対して追加で50％のダメージを与えます。ケーシィまたはユンゲラーのみが装備可能です。",
			"방어구가 있는 적에게 추가로 50% 피해를 줍니다. 몽키 또는 괴력몬만 장착할 수 있습니다.",
	...
	spellTag: { 
		...
		description: [
			...
			'Le porteur inflige 5 % de dégâts supplémentaires pour chaque état (Brûlé, Paralysé, Lent, Empoisonné) que possède la cible.',
			...
			'Der Träger verursacht 5 % mehr Schaden für jeden Zustand (Verbrannt, Gelähmt, Langsam, Vergiftet), den das Ziel hat.',
	...
	sharpBeak: {
		...
		description: [
			...
			'Augmente les dégâts en fonction de la proximité du porteur par rapport à la cible. Ne s\'active que sur la montagne.',
			...
			'Erhöht den Schaden basierend darauf, wie nah der Träger am Ziel ist. Aktiviert sich nur auf Bergen.',
	...
	sniperScope: {
		...
		description: [
			...
			'Les dégâts sont augmentés de 20 % si l’ennemi est à plus de 150 de portée et réduits de 20 % sinon. Utilisable uniquement par les Pokémon à projectiles.',
			...
			'Der Schaden wird um 20 % erhöht, wenn der Gegner weiter als 150 Reichweite entfernt ist, und um 20 % reduziert, wenn nicht. Nur für projektilebasierte Pokémon verwendbar.',
			'敵が射程150以上離れている場合、ダメージが20%増加し、そうでない場合は20%減少する。投射物系ポケモンのみ使用可能。',
			'적이 사거리 150 이상일 경우 피해가 20% 증가하고, 그렇지 않으면 20% 감소한다. 투사체 기반 포켓몬만 사용 가능.',
	...
	quickPowder: { 
		...
		description: [
			...
			'Réduit les dégâts de 50 % et le temps de recharge de 25 %. Seul Métamorph peut utiliser cet objet.',
			...
			'Reduziert den Schaden um 50% und die Wiederaufladezeit um 25%. Nur Ditto kann diesen Gegenstand benutzen.',
			'ダメージを50%軽減し、リチャージ時間を25%短縮する。このアイテムを使えるのはメタモンのみ。',
			'피해를 50% 감소시키고 재충전 시간을 25% 단축합니다. 이 아이템은 메타몽만 사용할 수 있습니다.',
	...
	metalPowder: { 
		...
		description: [
			...
			'Augmente les dégâts de 50 % et le temps de recharge de 25 %. Seul Métamorph peut utiliser cet objet.',
			...
			'Erhöht den Schaden um 50% und die Wiederaufladezeit um 25%. Nur Ditto kann diesen Gegenstand benutzen.',
			'ダメージが50%増加し、リチャージ時間が25%短縮される。このアイテムを使えるのはメタモンのみ。',
			'피해가 50% 증가하고 재충전 시간이 25% 단축됩니다. 이 아이템은 메타몽만 사용할 수 있습니다.',
	...
	hardStone: { 
		...
		description: [
			...
			'Augmente les dégâts infligés de 20 %. Seuls les Fossiles peuvent le tenir.',
			...
			'Erhöht den verursachten Schaden um 20%. Nur Fossilien können es tragen.',
	...
	domeFossil: {
		...
		description: [
		    ...
		    "팀에 있는 화석 포켓몬 하나당 치명타 확률이 5% 증가합니다. 카부토 또는 카부토프스만 장착할 수 있습니다.",
	...
	rockyHelmet: {
		...
		description: [
			...
			'Double le bonus de dégâts de Charkos de 5 % par cœur manquant à 10 % par cœur manquant.',
	...
	berryJuice: { 
		...
		description: [
			...
			"Die Verlangsamung ist 50% stärker. Nur Pottrott kann es tragen.",
	...
	blueBandana: { 
		...
		price: 175000,
		description: [
			"The holder can no longer deal critical hits. Increases damage by 1.75% for every 1% critical.",
			"El portador ya no puede ocasionar Críticos. Aumenta el daño un 1,75% por cada 1% de crítico.",
			"Le porteur ne peut plus infliger de coups critiques. Augmente les dégâts de 1,75 % pour chaque 1 % de critique.",
			"O portador não pode mais causar críticos. Aumenta o dano em 1,75% para cada 1% de crítico.",
			"Il portatore non può più infliggere colpi critici. Aumenta il danno dell'1,75% per ogni 1% di critico.",
			"Der Träger kann keine kritischen Treffer mehr verursachen. Erhöht den Schaden um 1,75% für jeden 1% Kritisch.",
			"持たせたポケモンはもうクリティカルを発生させられない。クリティカル1%ごとにダメージが1.75%増加する。",
			"소지자는 더 이상 크리티컬을 일으킬 수 없습니다. 크리티컬 1%마다 피해가 1.75% 증가합니다.",
			"持有者將無法再造成要害攻擊。每擁有 1% 要害率，傷害提高 1.75%。"
		],
		restriction: {
			idForbidden: [70, 19, 83]
		}
	...
	adrenalineOrb: { 
		...
		description: [
			...
			"Réduit le temps de recharge de 25 % lorsque les Cœurs sont à 7 ou moins.",
	...
	helixFossil: { 
		...
		description: [
		    ...
		    "Erhöht die Reichweite um 10 für jedes Fossil-Pokémon im Team. Kann nur von Amonitas oder Amonistar getragen werden.",
	...
	spindaCocktail: { 
		...
		description: [
			...
			'Augmente la portée de l’attaquant de 25 % mais fait que l’utilisateur cible des ennemis aléatoires, uniquement pour les Pokémon à cible unique.',
			...
			'Erhöht die Reichweite des Angreifers um 25 %, lässt den Benutzer aber zufällige Gegner anvisieren, nur für Einzelziel-Pokémon.',
	...
	dragonFang: { 
		...
		description: [
			...
			"Augmente la zone d'impact des projectiles de 100 %. Ne peut être tenu que par Drakkarmin.",
			...
			"Erhöht den Einschlagsbereich von Projektilen um 100%. Kann nur von Druddigon getragen werden.",
	...
	ejectButton: { 
		...
		description: [
			...
			"Réduit de moitié le temps de recharge de la téléportation. Ne peut être tenu que par Abra, Kadabra ou Alakazam.",
	...
	poisonBarb: { 
		...
		description: [
			...
			"Le porteur réduit le temps de recharge de 20 % et a 50 % de chance d'appliquer un stack de poison supplémentaire à chaque attaque.",
			...
			"Der Träger reduziert die Wiederaufladezeit um 20 % und hat eine 50% Chance, bei jedem Angriff einen zusätzlichen Giftschaden-Stapel anzuwenden.",
			"持たせたポケモンはリチャージ時間が20%短縮され、攻撃ごとに50%の確率で追加のどくスタックを付与する。",
			"소지자는 재충전 시간을 20% 단축하며, 공격마다 50% 확률로 추가 독 스택을 적용합니다.",
	...
	quickClaw: {
		...
		description: [
			...
			"Réduit les dégâts de 50 % et le temps de recharge de 50 %. La concentration cible automatiquement l'ennemi le plus rapide.",
	...
	revelationAroma: { 
		...
		description: [
			...
			"Erhöht die Reichweite um 25. Kann nur von Sonnkern, Sonnflora oder Comfey gehalten werden.",
			"射程が25増加します。ヒマナッツ、キマワリ、またはキュワワーのみが装備可能です。",
			"사거리가 25 증가합니다. 해바라기, 해루미, 또는 큐와링만 장착할 수 있습니다.",
	...
	falmeOrb: {
		...
		description: [
			...
			'Augmente les dégâts infligés par la brûlure de 25 %.',
	...
	badgeOfHonor: { 
		...
		description: [
			...
			"Augmente les dégâts du porteur de 1 % pour chaque 30 étoiles acquises.",
	...
	toxicOrb: { 
		...
		description: [
			...
			'Le porteur inflige le double de stacks de poison à chaque attaque.',
			...
			'Der Träger fügt mit jedem Angriff die doppelte Anzahl an Giftschichten zu.',
	...
	shinyCharm: {
		...
		description: [
		    ...
		    "Triple les chances de rendre un Pokémon Chromatique. Doit être tenu par Smeargle.",
		    ...
		    "Verdreifacht die Chancen, ein Pokémon schillernd zu machen. Muss von Smeargle gehalten werden.",
		    "ポケモンが色違いになる確率が3倍になります。ムーランドが持っている必要があります。",
		    "포켓몬이 색이 다른 Shiny가 될 확률이 3배가 됩니다. 스메어글이 장착해야 합니다.",
	...
	bicycle: {
		id: 'bicycle',
		name: ["Segmental's Bicycle", "La bicicleta de Segmental", "Le vélo de Segmental", "A bicicleta de Segmental", "La bicicletta di Segmental", "自転車", "자전거", '的自行車'],
